...
import official_perf_coverage as coverage


class OfficialPerfCoverageTest(unittest.TestCase):
    def test_check_helpers_accept_current_repository_map(self):
        cases = coverage.official_cases(coverage.ROOT)
    ...
    def test_missing_benchmark_refs_are_reported(self):
        cases = {"math": []}
        self.assertIn("suite/math_intensive", coverage.missing_benchmark_refs(cases, set()))
