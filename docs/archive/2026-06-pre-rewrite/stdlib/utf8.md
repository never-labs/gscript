...
The `utf8` library provides Unicode-aware string operations. Leia strings are byte strings internally; this library provides codepoint-level access using Go's `unicode/utf8` package.
