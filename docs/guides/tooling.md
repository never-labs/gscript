...
Each registry entry advertises `count_fields` and `collection_fields` when the
report exposes countable evidence. Release dashboards should read those fields
