...
func cliCommands() []cliCommandSpec {
	return []cliCommandSpec{
		...
		{Name: "mod", Usage: "usage: gscript mod [init|add|tidy|check|download|lock|list|graph|explain|verify] [flags]", Summary: "Manage local module metadata and require graphs.", Run: runModCommand},
