...
func cliCommands() []cliCommandSpec {
	return []cliCommandSpec{
		...
		{Name: "evaluate", Usage: "usage: leia evaluate [--json|--format=text] [path-or-dir...]", Summary: "Emit a syntax-level agent evaluation report skeleton.", Run: runEvaluateCommand},
