...
func cliCommands() []cliCommandSpec {
	return []cliCommandSpec{
		...
		{Name: "evaluate", Usage: "usage: leia evaluate [--json|--format=text] [--output FILE] [--list] [--filter TEXT] [--llm-replay FILE|--llm-record FILE|--update-golden FILE] [path-or-dir...]", Summary: "Run evaluate blocks and emit an agent evaluation report.", Run: runEvaluateCommand},
