...
func cliCommands() []cliCommandSpec {
	return []cliCommandSpec{
		...
		{Name: "evaluate", Usage: "usage: leia evaluate [--json|--format=text] [--llm-replay FILE|--llm-record FILE] [path-or-dir...]", Summary: "Run evaluate blocks and emit an agent evaluation report.", Run: runEvaluateCommand},
