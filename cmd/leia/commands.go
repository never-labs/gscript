...
func cliCommands() []cliCommandSpec {
	return []cliCommandSpec{
		{Name: "bench", Usage: "usage: leia bench [--manifest-check|--quick|--full|--guard|BENCH|compare [--quick]|strict|diagnose|audit|rank-luajit-gaps|debug-artifact|coverage|profile-exits|validate-lua-refs] [benchmark-harness-flags...]", Summary: "Run benchmark and benchmark-diagnostic harnesses.", Run: runBenchCommand},
