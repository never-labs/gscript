...
func buildReportCapabilities() []cliReportCapability {
	return []cliReportCapability{
		...
		{Command: "scripts/release_notes_check.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", ScalarFields: []string{"require_ready", "version"}, CountFields: []string{"checked_file_count", "required_artifact_count", "artifact_checksum_count", "failure_count"}, CollectionFields: []string{"checked_files", "failures"}},
