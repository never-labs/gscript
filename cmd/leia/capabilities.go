...
func buildReportCapabilities() []cliReportCapability {
	return []cliReportCapability{
		...
		{Command: "scripts/diagnostics_bundle.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", ScalarFields: []string{"output_dir"}, CountFields: []string{"failure_count", "file_count"}, CollectionFields: []string{"failure_details", "files"}, CollectionItemFields: []string{"files[]"}},
		{Command: "scripts/docs_check.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"failure_count", "failure_kind_count", "counts.markdown_files", "counts.relative_documentation_links", "counts.runnable_spec_examples"}, CollectionFields: []string{"failures", "failure_kinds", "failure_details"}, CollectionItemFields: []string{"failures[]", "failure_kinds[]", "failure_details[].kind", "failure_details[].message"}},
