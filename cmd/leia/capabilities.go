...
func buildReportCapabilities() []cliReportCapability {
	return []cliReportCapability{
		...
		{Command: "scripts/performance_gate.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", ScalarFields: []string{"validate_only", "timing_json", "no_luajit", "threshold", "wall_threshold", "luajit_threshold"}, CountFields: []string{"failure_count", "failure_kind_count", "output_line_count"}, CollectionFields: []string{"failure_kinds", "failures", "failure_details", "output_lines"}},
