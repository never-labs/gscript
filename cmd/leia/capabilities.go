...
func buildReportCapabilities() []cliReportCapability {
	return []cliReportCapability{
		...
		{Command: "scripts/diagnostics_bundle.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"failure_count", "file_count"}, CollectionFields: []string{"files"}},
		...
		{Command: "scripts/editor_check.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"textmate_grammar_count", "vscode_asset_count", "tree_sitter_asset_count", "smoke_test_count"}, CollectionFields: []string{"textmate_grammars", "vscode_assets", "tree_sitter_assets", "smoke_tests"}},
		{Command: "scripts/install.sh --dry-run --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"install_count", "binary_count", "install_path_count"}, CollectionFields: []string{"binaries", "install_paths"}},
		{Command: "scripts/performance_gate.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"failure_count", "output_line_count"}, CollectionFields: []string{"failures", "output_lines"}},
		{Command: "scripts/production_check.sh --list --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"run_count", "skip_count", "critical_skip_count", "release_critical_skip_name_count"}, CollectionFields: []string{"runnable_checks", "skipped_checks", "release_critical_skip_names", "release_critical_skips"}},
		{Command: "scripts/public_release_blockers_check.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"blocker_count", "missing_file_count", "release_decision_count", "stale_text_count", "unconfirmed_policy_count", "missing_guidance_count", "missing_doc_snippet_count", "decision_area_count"}, CollectionFields: []string{"blockers", "blocker_details", "decision_areas"}},
		...
		{Command: "scripts/release_artifacts.sh --dry-run --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"artifact_count", "checksum_entry_count"}, CollectionFields: []string{"artifact_files"}},
		{Command: "scripts/release_artifacts_check.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", CountFields: []string{"artifact_count", "checksum_entry_count", "install_archive_checksum_count"}, CollectionFields: []string{"artifact_files"}},
