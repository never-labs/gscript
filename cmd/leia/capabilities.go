...
func buildReportCapabilities() []cliReportCapability {
	return []cliReportCapability{
		...
		{Command: "leia mod download --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "ok", CollectionFields: []string{"modules", "diagnostics"}},
		{Command: "leia mod explain --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "ok", CollectionFields: []string{"diagnostics"}},
		{Command: "leia mod gomod --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "ok", CollectionFields: []string{"diagnostics"}},
		{Command: "leia mod graph --json", Formats: []string{"json"}, SchemaVersion: 1, CollectionFields: []string{"files", "diagnostics"}},
		{Command: "leia mod list --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "ok", CollectionFields: []string{"requires", "replaces", "collections", "diagnostics"}},
		{Command: "leia mod lock --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "ok", CollectionFields: []string{"entries", "diagnostics"}},
		{Command: "leia mod tidy --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "ok", CollectionFields: []string{"removed", "missing", "diagnostics"}},
		{Command: "leia mod vendor --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "ok", CollectionFields: []string{"modules", "diagnostics"}},
		{Command: "leia mod verify --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "ok", CollectionFields: []string{"graph.files", "diagnostics"}},
