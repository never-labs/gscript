...
func buildReportCapabilities() []cliReportCapability {
	return []cliReportCapability{
		...
		{Command: "scripts/public_release_blockers_check.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", ScalarFields: []string{"require_resolved"}, CountFields: []string{"blocker_count", "missing_file_count", "release_decision_count", "stale_text_count", "unconfirmed_policy_count", "missing_guidance_count", "missing_doc_snippet_count", "open_blocker_count", "blocker_status_count", "decision_area_count"}, CollectionFields: []string{"blockers", "blocker_details", "blocker_statuses", "blocker_status_details", "decision_areas"}},
		...
		{Command: "scripts/worktree_audit.sh --json", Formats: []string{"json"}, SchemaVersion: 1, StatusField: "status", ScalarFields: []string{"fail_on_findings"}, CountFields: []string{"finding_count", "finding_status_count"}, CollectionFields: []string{"findings", "finding_statuses"}},
	}
}
