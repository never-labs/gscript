...
func TestGenericCodingWorkspaceLivePackageExecutableSkeleton(t *testing.T) {
	...
	for _, result := range runFinRobotLivePackageSummarySmoke(t, path, "generic_coding_workspace_live_package_summary", "generic_coding_workspace_live_package", leia.LibString) {
