...
func TestGenericChartRenderContractsLivePackageExecutableSkeleton(t *testing.T) {
	...
	for _, result := range runFinRobotLivePackageSummarySmoke(t, path, "generic_chart_render_contracts_live_package_summary", "generic_chart_render_contracts_live_package", leia.LibString) {
