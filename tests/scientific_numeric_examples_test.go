...
func TestScientificNumericExamplesSourceContract(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			summary: "ok particle ",
			wantAPI: []string{"rand.seed", "stats.normal", "rand.sample", "linalg.add", "linalg.sub", "stats.uniform_weights", "stats.logpdf", "stats.importance_update", "stats.mean", "stats.describe", "math.near", "q {"},
		},
		{
