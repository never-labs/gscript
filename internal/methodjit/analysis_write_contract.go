...
var analysisFactForDomainField = map[string]AnalysisFact{
	...
	"profiledIntRanges":              AnalysisFactProfiledIntRanges,
	"tableArrayDataPtrs":             AnalysisFactTableArrayDataPtrs,
	"tableArrayLowerBoundSafe":       AnalysisFactTableArrayBoundsSafe,
	"tableArrayUpperBoundSafe":       AnalysisFactTableArrayBoundsSafe,
	"loopTableArrayFacts":            AnalysisFactLoopTableArrayFacts,
