...
func (ec *emitContext) emitTableInstr(instr *Instr) bool {
	...
	case OpFrameLen, OpFrameColumn, OpFrameMask, OpFrameProject, OpFrameFilter, OpFrameGather, OpFrameSlice, OpFrameOrder, OpVectorGather, OpVectorCompare, OpQFrameSelectColumn:
		ec.emitOpExit(instr)
	case OpSetList:
