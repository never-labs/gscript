...
func buildRecordArraySpecializationFromFieldPairs(shapeID uint32, pairs []tableFieldUpdatePair) RecordArrayLoopSpecializationSpec {
	spec := RecordArrayLoopSpecializationSpec{ShapeID: shapeID, ScalarCount: 2}
