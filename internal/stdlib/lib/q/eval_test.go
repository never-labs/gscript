...
func TestEvalTypedCasts(t *testing.T) {
	...
	assertEvalValue(t, "7$\"42\"", int64(42))
	assertEvalValue(t, "-7$\"42\"", int64(42))
	assertEvalValue(t, "6$\"42\"", int32(42))
	...
	assertEvalArray(t, "7$\"1\" \"2\"", data.KindI64, []any{int64(1), int64(2)})
	assertEvalArray(t, "-6$\"1\" \"2\"", data.KindI32, []any{int32(1), int32(2)})
