...
var modules = []ModuleInfo{
	...
	{Name: "data", Layer: LayerData, Description: "Column arrays, frames, and shared query-plan helpers.", SafeDefault: true},
	...
	{Name: "linalg", Layer: LayerData, Description: "Dense vector and matrix construction, algebra, solves, and norms.", SafeDefault: true},
	...
	{Name: "ode", Layer: LayerData, Description: "Reusable numeric ODE integration helpers over typed state vectors.", SafeDefault: true},
	...
	{Name: "stats", Layer: LayerData, Description: "Numeric reductions, normalization, scans, and resampling helpers.", SafeDefault: true},
