...
`)
	...
	assertMatrixFloat(t, interp.GetGlobal("dense_values_matrix"), 2, 2, 4, 4)
	...
	assertTableFloat(t, interp.GetGlobal("ov"), 3, 1)
	assertMatrixFloat(t, interp.GetGlobal("om"), 2, 2, 4, 1)
...
`)
	...
	assertFloat(t, interp.GetGlobal("dot_row_col"), 11)
	assertFloat(t, interp.GetGlobal("norm"), 5)
	assertFloat(t, interp.GetGlobal("norm_row"), 5)
	assertTableFloat(t, interp.GetGlobal("mv"), 1, 50)
	assertTableFloat(t, interp.GetGlobal("mv_col"), 2, 110)
	...
	assertMatrixFloat(t, interp.GetGlobal("swadd"), 2, 2, 1, 6)
	assertMatrixFloat(t, interp.GetGlobal("swadd"), 2, 2, 4, 2)
	assertMatrixFloat(t, interp.GetGlobal("swshift"), 2, 2, 3, 12)
	...
	assertTableFloat(t, interp.GetGlobal("sol_col"), 2, 0.6)
	assertTableFloat(t, interp.GetGlobal("solg"), 1, 0.2)
	assertTableFloat(t, interp.GetGlobal("solg"), 2, 0.6)
	assertTableFloat(t, interp.GetGlobal("solg_row"), 1, 0.2)
