...
`)
	...
	assertQEvalRuntimeKernelStat(t, stats, "ArraySum", "vector-reduce/sum/i64", "attempt", 2)
	assertQEvalRuntimeKernelStat(t, stats, "ArraySum", "vector-reduce/sum/i64", "hit", 2)
	assertQEvalRuntimeKernelStat(t, stats, "ArrayLastScan", "vector-last/sums/i64", "attempt", 1)
	assertQEvalRuntimeKernelStat(t, stats, "ArrayLastScan", "vector-last/sums/i64", "hit", 1)
