...
type TableSortCaller = Caller
type TableSortLess = Less
type TableSortLen = Len
type TableSortGet = Get
type TableSortSet = Set
type TableSortTryPlainArraySort = TryPlainArraySort
type TableMoveGet = MoveGet
type TableMoveSet = MoveSet
type TableMoveTryPlainArrayMove = TryPlainArrayMove
type TableInsertLen = InsertLen
type TableInsertGet = InsertGet
type TableInsertSet = InsertSet
type TableInsertTryPlainArrayInsert = TryPlainArrayInsert
type TableRemoveLen = RemoveLen
type TableRemoveGet = RemoveGet
type TableRemoveSet = RemoveSet
type TableRemoveTryPlainArrayRemove = TryPlainArrayRemove
type TableUnpackLen = UnpackLen
type TableUnpackGet = UnpackGet
