...
func TestOpName(t *testing.T) {
	...
	if OpName(OP_FRAME_GROUP_AGGREGATE) != "FRAME_GROUP_AGGREGATE" {
		t.Errorf("OpName(OP_FRAME_GROUP_AGGREGATE): got %q, want FRAME_GROUP_AGGREGATE", OpName(OP_FRAME_GROUP_AGGREGATE))
	}
}
