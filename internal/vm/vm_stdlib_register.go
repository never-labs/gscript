...
func (vm *VM) RegisterStdlibRuntimeModules() {
	stdlibinstall.InstallModules(vm.newStdlibInstallContext(), func() int64 {
		...
		Host: stdbind.HostOptions{
			...
			FilesystemRoot:        vm.FilesystemRoot,
			FilesystemRead:        func() bool { return vm.filesystemRead },
			FilesystemWrite:       func() bool { return vm.filesystemWrite },
			MaxFSReadBytes:        func() int64 { return vm.maxFSReadBytes },
			MaxFSWriteBytes:       func() int64 { return vm.maxFSWriteBytes },
			EnvironmentRead:       func() bool { return vm.environmentRead },
			EnvironmentWrite:      func() bool { return vm.environmentWrite },
			EnvironmentAllowed:    vm.EnvironmentAllowed,
			ProcessExecution:      func() bool { return vm.processExecution },
			ProcessShell:          func() bool { return vm.processShell },
			ResolveFilesystemPath: vm.ResolveFilesystemPath,
