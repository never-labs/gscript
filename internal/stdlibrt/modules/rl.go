...
// rl.go: raylib graphics/audio bindings. Gated behind `-tags rl`
...
// build uses the stub in rl_stub.go. Enable with:
//   go build -tags rl ./...
//   go test  -tags rl ./...
...
// ---------------------------------------------------------------------------
// BuildRL returns the raylib module exposed to GScript as the "rl" global.
// ---------------------------------------------------------------------------
