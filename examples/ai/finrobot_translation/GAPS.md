...
directory. The current provider-free surface is 87 registered examples plus
41 checked-in live-package skeleton directories:
...
RAG, evidence/report artifacts, UI snapshot evaluation, prompt/role catalogs,
memory stores, turn, tool, agent, workflow, evaluation, replay, trace,
...
confirm 19 registered `live_packages/generic_*` examples and three top-level
