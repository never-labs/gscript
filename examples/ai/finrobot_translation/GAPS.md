...
36 checked-in live-package skeleton directories:
...
package contracts for model, model IO envelopes, memory stores, turn, tool, agent, workflow, evaluation, replay,
...
confirm 14 registered `live_packages/generic_*` examples and three top-level
