...
directory. The current provider-free surface is 81 registered examples plus
34 checked-in live-package skeleton directories:
...
confirm 12 registered `live_packages/generic_*` examples and three top-level
