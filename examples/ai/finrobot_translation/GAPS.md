...
directory. The current provider-free surface is 50 registered examples plus
20 checked-in live-package skeleton directories:
...
`live_packages/valuation_engine`, and `live_packages/vendor_adapters`.
