...
directory. The current provider-free surface is 96 registered examples plus
50 checked-in live-package skeleton directories:
...
confirm 28 registered `live_packages/generic_*` examples and three top-level
