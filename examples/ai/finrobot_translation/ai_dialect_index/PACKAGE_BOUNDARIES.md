...
| --- | --- | --- |
| Package composition | `generic_model_registry`, `generic_turn_runner`, `generic_tool_contracts`, `generic_agent_runner`, `generic_workflow_orchestrator` | Leia scripts declare aliases, messages, tools, agents, and workflow graphs; packages own validation, envelopes, loop semantics, and stage I/O. |
