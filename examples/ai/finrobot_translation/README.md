...
Current status: `go run ./cmd/leia examples list --json` discovers 81 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 34 directories:
...
`live_packages/vendor_adapters`. All 34 skeletons provide registered
