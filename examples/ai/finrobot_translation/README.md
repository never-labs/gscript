...
Current status: `go run ./cmd/leia examples list --json` discovers 86 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 40 directories:
...
`live_packages/vendor_adapters`. All 40 skeletons provide registered
