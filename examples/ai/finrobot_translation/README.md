...
Current status: `go run ./cmd/leia examples list --json` discovers 97 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 51 directories:
...
`live_packages/generic_analytical_model_contracts`,
`live_packages/generic_approval_policy`,
`live_packages/generic_chart_render_contracts`,
`live_packages/generic_coding_workspace`,
`live_packages/generic_data_normalization_contracts`,
`live_packages/generic_data_provider_boundary`,
...
`live_packages/generic_memory_store`,
...
`live_packages/generic_planning_graph`, `live_packages/generic_record_replay`,
...
`live_packages/generic_trace_events`,
`live_packages/generic_transcript_pipeline`, `live_packages/generic_turn_runner`,
...
`live_packages/vendor_adapters`. All 51 skeletons provide registered
