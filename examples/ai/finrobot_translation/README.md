...
Current status: `go run ./cmd/leia examples list --json` discovers 85 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 39 directories:
...
`live_packages/vendor_adapters`. All 39 skeletons provide registered
