...
Current status: `go run ./cmd/leia examples list --json` discovers 92 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 46 directories:
...
`live_packages/vendor_adapters`. All 46 skeletons provide registered
