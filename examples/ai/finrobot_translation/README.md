...
Current status: `go run ./cmd/leia examples list --json` discovers 99 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 53 directories:
...
`live_packages/vendor_adapters`. All 53 skeletons provide registered
