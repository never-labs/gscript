...
Current status: `go run ./cmd/leia examples list --json` discovers 91 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 45 directories:
...
`live_packages/vendor_adapters`. All 45 skeletons provide registered
