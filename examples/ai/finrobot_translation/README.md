...
Current status: `go run ./cmd/leia examples list --json` discovers 98 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 52 directories:
...
`live_packages/vendor_adapters`. All 52 skeletons provide registered
