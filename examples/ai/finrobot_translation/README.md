...
Current status: `go run ./cmd/leia examples list --json` discovers 87 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 41 directories:
...
`live_packages/vendor_adapters`. All 41 skeletons provide registered
