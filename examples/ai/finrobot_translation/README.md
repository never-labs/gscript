...
Current status: `go run ./cmd/leia examples list --json` discovers 95 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 49 directories:
...
`live_packages/vendor_adapters`. All 49 skeletons provide registered
