...
Current status: `go run ./cmd/leia examples list --json` discovers 90 runnable
and checkable FinRobot translation examples under this directory. The
checked-in live-package skeleton surface has 44 directories:
...
`live_packages/vendor_adapters`. All 44 skeletons provide registered
